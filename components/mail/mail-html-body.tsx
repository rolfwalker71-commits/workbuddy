    ...
    <div className={cn("space-y-2", className)}>
      {showBanner ? (
        <div className="flex flex-wrap items-center justify-between gap-2 rounded-lg border border-amber-200/80 bg-amber-50 px-3 py-2 text-xs text-amber-950 dark:border-amber-400/30 dark:bg-amber-500/12 dark:text-amber-100">
          ...
          <Button
            ...
            size="sm"
            variant="outline"
            className="h-7 gap-1.5 border-amber-300 bg-white text-[0.6875rem] dark:border-amber-400/40 dark:bg-card dark:text-amber-100"
      ...
      <div
        className={cn(
          ...
          "[&_.mail-img-ph]:inline-block [&_.mail-img-ph]:rounded [&_.mail-img-ph]:bg-muted [&_.mail-img-ph]:px-1.5 [&_.mail-img-ph]:py-0.5 [&_.mail-img-ph]:text-[0.625rem] [&_.mail-img-ph]:text-muted-foreground"
        )}
